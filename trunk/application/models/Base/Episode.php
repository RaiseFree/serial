...
/**
 * Base class that represents a row from the 'episode' table.
 *
 *
 *
...
abstract class Episode implements ActiveRecordInterface
{
    ...
    public function setSerialId($v)
    {
        ...
        if ($this->serial_id !== $v) {
            $this->serial_id = $v;
            $this->modifiedColumns[EpisodeTableMap::COL_SERIAL_ID] = true;
        }
    ...
    public function setSourceId($v)
    {
        ...
        if ($this->source_id !== $v) {
            $this->source_id = $v;
            $this->modifiedColumns[EpisodeTableMap::COL_SOURCE_ID] = true;
        }
    ...
    public function setSeason($v)
    {
        ...
        if ($this->season !== $v) {
            $this->season = $v;
            $this->modifiedColumns[EpisodeTableMap::COL_SEASON] = true;
        }
    ...
    public function setNumber($v)
    {
        ...
        if ($this->number !== $v) {
            $this->number = $v;
            $this->modifiedColumns[EpisodeTableMap::COL_NUMBER] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[EpisodeTableMap::COL_NAME] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[EpisodeTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[EpisodeTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EpisodeTableMap::translateFieldName('SerialId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->serial_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EpisodeTableMap::translateFieldName('SourceId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->source_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EpisodeTableMap::translateFieldName('Season', TableMap::TYPE_PHPNAME, $indexType)];
            $this->season = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EpisodeTableMap::translateFieldName('Number', TableMap::TYPE_PHPNAME, $indexType)];
            $this->number = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : EpisodeTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : EpisodeTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : EpisodeTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 8; // 8 = EpisodeTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(EpisodeTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(EpisodeTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(EpisodeTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[EpisodeTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . EpisodeTableMap::COL_ID . ')');
        }
        ...
        if ($this->isColumnModified(EpisodeTableMap::COL_SERIAL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'serial_id';
        }
        if ($this->isColumnModified(EpisodeTableMap::COL_SOURCE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'source_id';
        }
        if ($this->isColumnModified(EpisodeTableMap::COL_SEASON)) {
            $modifiedColumns[':p' . $index++]  = 'season';
        }
        if ($this->isColumnModified(EpisodeTableMap::COL_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'number';
        }
        if ($this->isColumnModified(EpisodeTableMap::COL_NAME)) {
        ...
        $sql = sprintf(
            'INSERT INTO episode (%s) VALUES (%s)',
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EpisodeTableMap::COL_SERIAL_ID)) {
            $criteria->add(EpisodeTableMap::COL_SERIAL_ID, $this->serial_id);
        }
        if ($this->isColumnModified(EpisodeTableMap::COL_SOURCE_ID)) {
            $criteria->add(EpisodeTableMap::COL_SOURCE_ID, $this->source_id);
        }
        if ($this->isColumnModified(EpisodeTableMap::COL_SEASON)) {
            $criteria->add(EpisodeTableMap::COL_SEASON, $this->season);
        }
        if ($this->isColumnModified(EpisodeTableMap::COL_NUMBER)) {
            $criteria->add(EpisodeTableMap::COL_NUMBER, $this->number);
        }
        if ($this->isColumnModified(EpisodeTableMap::COL_NAME)) {
            $criteria->add(EpisodeTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(EpisodeTableMap::COL_CREATED_AT)) {
            $criteria->add(EpisodeTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(EpisodeTableMap::COL_UPDATED_AT)) {
            $criteria->add(EpisodeTableMap::COL_UPDATED_AT, $this->updated_at);
        }
