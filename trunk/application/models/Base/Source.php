...
abstract class Source implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\SourceTableMap';
    ...
    /**
     * Initializes internal state of Base\Source object.
     */
     ...
     * @return $this|\Source The current object (for fluent API support)
     */
    ...
    public function setSerialId($v)
    {
        ...
        if ($this->serial_id !== $v) {
            $this->serial_id = $v;
            $this->modifiedColumns[SourceTableMap::COL_SERIAL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[SourceTableMap::COL_NAME] = true;
        }
    ...
    public function setUrl($v)
    {
        ...
        if ($this->url !== $v) {
            $this->url = $v;
            $this->modifiedColumns[SourceTableMap::COL_URL] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SourceTableMap::translateFieldName('SerialId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->serial_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SourceTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SourceTableMap::translateFieldName('Url', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Source'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SourceTableMap::COL_SERIAL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'serial_id';
        }
        if ($this->isColumnModified(SourceTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(SourceTableMap::COL_URL)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SourceTableMap::COL_SERIAL_ID)) {
            $criteria->add(SourceTableMap::COL_SERIAL_ID, $this->serial_id);
        }
        if ($this->isColumnModified(SourceTableMap::COL_NAME)) {
            $criteria->add(SourceTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(SourceTableMap::COL_URL)) {
            $criteria->add(SourceTableMap::COL_URL, $this->url);
        }
        if ($this->isColumnModified(SourceTableMap::COL_CREATED_AT)) {
    ...
    {
        return (null === $this->getId()) && (null === $this->getSerialId());
    }
