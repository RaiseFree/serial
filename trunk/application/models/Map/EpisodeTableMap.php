...
class EpisodeTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'episode.id';

    /**
     * the column name for the serial_id field
     */
    const COL_SERIAL_ID = 'episode.serial_id';

    /**
     * the column name for the source_id field
     */
    const COL_SOURCE_ID = 'episode.source_id';

    /**
     * the column name for the season field
     */
    const COL_SEASON = 'episode.season';

    /**
     * the column name for the number field
     */
    const COL_NUMBER = 'episode.number';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'episode.name';

    /**
     * the column name for the created_at field
     */
    const COL_CREATED_AT = 'episode.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'episode.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'SerialId', 'SourceId', 'Season', 'Number', 'Name', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'serialId', 'sourceId', 'season', 'number', 'name', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(EpisodeTableMap::COL_ID, EpisodeTableMap::COL_SERIAL_ID, EpisodeTableMap::COL_SOURCE_ID, EpisodeTableMap::COL_SEASON, EpisodeTableMap::COL_NUMBER, EpisodeTableMap::COL_NAME, EpisodeTableMap::COL_CREATED_AT, EpisodeTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'serial_id', 'source_id', 'season', 'number', 'name', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'SerialId' => 1, 'SourceId' => 2, 'Season' => 3, 'Number' => 4, 'Name' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'serialId' => 1, 'sourceId' => 2, 'season' => 3, 'number' => 4, 'name' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        self::TYPE_COLNAME       => array(EpisodeTableMap::COL_ID => 0, EpisodeTableMap::COL_SERIAL_ID => 1, EpisodeTableMap::COL_SOURCE_ID => 2, EpisodeTableMap::COL_SEASON => 3, EpisodeTableMap::COL_NUMBER => 4, EpisodeTableMap::COL_NAME => 5, EpisodeTableMap::COL_CREATED_AT => 6, EpisodeTableMap::COL_UPDATED_AT => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'serial_id' => 1, 'source_id' => 2, 'season' => 3, 'number' => 4, 'name' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(EpisodeTableMap::COL_SERIAL_ID);
            $criteria->addSelectColumn(EpisodeTableMap::COL_SOURCE_ID);
            $criteria->addSelectColumn(EpisodeTableMap::COL_SEASON);
            $criteria->addSelectColumn(EpisodeTableMap::COL_NUMBER);
            $criteria->addSelectColumn(EpisodeTableMap::COL_NAME);
            $criteria->addSelectColumn(EpisodeTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(EpisodeTableMap::COL_UPDATED_AT);
        } else {
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(EpisodeTableMap::COL_ID) && $criteria->keyContainsValue(EpisodeTableMap::COL_ID) ) {
